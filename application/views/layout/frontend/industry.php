...
<!-- BreadCrumbb -->
<div class="container">
	<div class="breadcrummb">
		<ul class="breadcrumb-list d-flex list-unstyled gap-5">
			<li class="breadcrumb-item-cp">
				<a class="text-link theme-font-color" href="/index.html">Home</a>
				<i class="bi bi-chevron-right"></i>
			</li>
			<li class="breadcrumb-item-cp font-weight-bold">Industries</li>
		</ul>
	</div>
</div>
<!-- BreadCrumbb -->
...
<section class="coll-indust">
	<div class="container">
		<h2 class="Ind-heading">A solution for every industry
		</h2>
		<div class="row">
